...
import { ChevronLeftIcon, UserIcon, CalendarIcon, DesignStudioIcon, MapPinIcon, EditIcon, TrashIcon, CreditCardIcon, PhotoIcon, CameraIcon } from '../common/Icons';
...
const ClientDetailPage: React.FC<ClientDetailPageProps> = ({ client, onBack, onEdit, onDelete }) => {
  const { appointments, services, hairstylists, getCurrentUserLookbooks, t, currency, updateClient, session } = useSettings();
                ...
                <div className="bg-white dark:bg-gray-800/50 p-4 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700/50">
                  <div className="space-y-6">
                    {clientPhotoPairs.map((photoPair, index) => (
                      <div key={photoPair.id} className="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-b-0 last:pb-0">
