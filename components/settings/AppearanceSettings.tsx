        ...
        <div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold w-24 ${theme === 'light' ? `${mapToAccentColor('bg-blue-500')} text-white` : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            >
              Light
            </button>
            <button
              onClick={() => setTheme('dark')}
              className={`px-4 py-2 rounded-lg font-semibold w-24 ${theme === 'dark' ? `${mapToAccentColor('bg-blue-500')} text-white` : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            >
              Dark
            </button>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3 mb-3">
            ...
            <button
              ...
              style={
                accentColor === 'custom' ? { backgroundColor: customAccentColor || '#8b5cf6' } : {}
              }
              title="Custom Color"
            >
              {accentColor !== 'custom' && (
        ...
        <div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold w-28 ${typography === 'sans' ? `${mapToAccentColor('bg-blue-500')} text-white` : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            >
              Sans-Serif
            </button>
            <button
              onClick={() => setTypography('serif')}
              className={`px-4 py-2 rounded-lg font-semibold w-28 font-serif ${typography === 'serif' ? `${mapToAccentColor('bg-blue-500')} text-white` : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            >
              Serif
            </button>
          </div>
