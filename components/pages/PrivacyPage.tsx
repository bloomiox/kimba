...
interface PrivacyPageProps {
  onNavigate: (
    page: 'signin' | 'signup' | 'landing' | 'about' | 'contact' | 'blog' | 'terms'
  ) => void;
}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <h4 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">
                  {t('privacy.highlights.encryption.title')}
                </h4>
              ...
              <div className="text-center p-6">
                ...
                <h4 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">
                  {t('privacy.highlights.transparency.title')}
                </h4>
                <p className="text-gray-600 dark:text-gray-400">
              ...
              <div className="text-center p-6">
                ...
                <h4 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">
                  {t('privacy.highlights.control.title')}
                </h4>
                <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <div className="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    <strong>{t('privacy.sharing.list.providers.title')}:</strong>{' '}
                    {t('privacy.sharing.list.providers.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.sharing.list.legal.title')}:</strong>{' '}
                    {t('privacy.sharing.list.legal.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.sharing.list.business.title')}:</strong>{' '}
                    {t('privacy.sharing.list.business.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.sharing.list.consent.title')}:</strong>{' '}
                    {t('privacy.sharing.list.consent.description')}
                  </li>
                </ul>
              </div>
              ...
              <div className="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    <strong>{t('privacy.rights.list.access.title')}:</strong>{' '}
                    {t('privacy.rights.list.access.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.rights.list.correction.title')}:</strong>{' '}
                    {t('privacy.rights.list.correction.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.rights.list.deletion.title')}:</strong>{' '}
                    {t('privacy.rights.list.deletion.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.rights.list.portability.title')}:</strong>{' '}
                    {t('privacy.rights.list.portability.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.rights.list.objection.title')}:</strong>{' '}
                    {t('privacy.rights.list.objection.description')}
                  </li>
                  <li>
                    <strong>{t('privacy.rights.list.withdrawal.title')}:</strong>{' '}
                    {t('privacy.rights.list.withdrawal.description')}
                  </li>
                </ul>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <span className="text-accent font-semibold">{t('footer.legal.privacy')}</span>
                </li>
                <li>
                  <button
