...
interface CapabilitiesPageProps {
  onNavigate: (page: 'signin' | 'signup' | 'landing' | 'about' | 'contact' | 'blog' | 'terms' | 'privacy') => void;
}
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 px-6 text-center bg-gradient-to-br from-white via-accent-50/30 to-accent-100/20 dark:from-gray-900 dark:via-accent-950/30 dark:to-accent-900/20">
          <div className="container mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white">{t('capabilities.hero.title')}</h2>
        ...
        <section className="py-20 px-6">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h3 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900 dark:text-white">{t('capabilities.overview.title')}</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="text-center p-8 bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-200 dark:border-red-800">
                ...
                <h4 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">{t('capabilities.overview.problems.title')}</h4>
              ...
              <div className="text-center p-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                ...
                <h4 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">{t('capabilities.overview.solution.title')}</h4>
              ...
              <div className="text-center p-8 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-800">
                ...
                <h4 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">{t('capabilities.overview.results.title')}</h4>
                <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
        ...
        <section className="py-20 px-6 bg-gray-100 dark:bg-gray-800/50">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h3 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900 dark:text-white">{t('capabilities.detailed.title')}</h3>
        ...
        <section className="py-20 px-6">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h3 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900 dark:text-white">{t('capabilities.integration.title')}</h3>
              <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
                <div className="flex flex-col lg:flex-row items-center gap-8">
                  <div className="flex-1">
                    <h4 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">{t('capabilities.integration.workflow.title')}</h4>
                    <div className="space-y-4">
                      <div className="flex items-center gap-4">
                        <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-bold text-sm">1</div>
                        <span className="text-gray-700 dark:text-gray-300">{t('capabilities.integration.workflow.step1')}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-bold text-sm">2</div>
                        <span className="text-gray-700 dark:text-gray-300">{t('capabilities.integration.workflow.step2')}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-bold text-sm">3</div>
                        <span className="text-gray-700 dark:text-gray-300">{t('capabilities.integration.workflow.step3')}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-bold text-sm">4</div>
                        <span className="text-gray-700 dark:text-gray-300">{t('capabilities.integration.workflow.step4')}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-bold text-sm">5</div>
                        <span className="text-gray-700 dark:text-gray-300">{t('capabilities.integration.workflow.step5')}</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex-1">
                    <div className="bg-gradient-to-br from-accent/10 to-accent/5 rounded-xl p-6">
                      ...
                      <h5 className="text-lg font-bold text-center mb-3 text-gray-900 dark:text-white">{t('capabilities.integration.unified.title')}</h5>
        ...
        <section className="py-20 px-6 bg-accent text-white">
          <div className="container mx-auto text-center">
            ...
            <p className="max-w-xl mx-auto text-accent-100 mb-8">{t('capabilities.cta.subtitle')}</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button onClick={() => onNavigate('signup')} className="px-8 py-4 bg-white hover:bg-gray-100 rounded-lg text-lg font-bold text-accent transition-all shadow-2xl">
                {t('capabilities.cta.tryFree')}
              </button>
              <button onClick={() => onNavigate('contact')} className="px-8 py-4 bg-accent-600 hover:bg-accent-700 border-2 border-white/20 rounded-lg text-lg font-bold text-white transition-all">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><span className="text-accent font-semibold">{t('capabilities.nav.capabilities')}</span></li>
    ...
    <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-12`}>
      <div className="flex-1">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h5 className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-2">Our Solution</h5>
      ...
      <div className="flex-1">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          <div className="mb-6">
            <h5 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Key Benefits</h5>
          ...
          <div>
            <h5 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Core Features</h5>
            <ul className="space-y-2">
