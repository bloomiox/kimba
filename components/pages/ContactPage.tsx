...
interface ContactPageProps {
  onNavigate: (
    page: 'signin' | 'signup' | 'landing' | 'about' | 'capabilities' | 'blog' | 'terms' | 'privacy'
  ) => void;
}
          ...
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">{t('contact.chat.description')}</p>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">{t('contact.help.description')}</p>
