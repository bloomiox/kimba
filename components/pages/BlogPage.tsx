...
import { LogoIcon, HeartIcon, CalendarIcon, ClockIcon, UserIcon, ArrowRightIcon, TagIcon } from '../common/Icons';
import LanguageSwitcher from '../common/LanguageSwitcher';

interface BlogPageProps {
  onNavigate: (page: 'signin' | 'signup' | 'landing' | 'about' | 'contact' | 'terms' | 'privacy') => void;
}
  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      excerpt: 'Discover proven strategies to attract new clients, increase retention, and boost your salon\'s revenue in 2024.',
    ...
    },
    {
      ...
      excerpt: 'From vibrant balayage to subtle highlights, explore the hottest hair color trends that your clients will love.',
      content: 'Full article content would go here...',
    ...
    },
    {
      ...
      excerpt: 'Learn how artificial intelligence tools like Kimba are transforming how beauty professionals work and serve clients.',
      content: 'Full article content would go here...',
      author: 'Tech Team',
      date: '2024-01-10',
      readTime: '6 min read',
    ...
    },
    {
      ...
      excerpt: 'Professional techniques and insider secrets for creating salon-quality blowouts that last.',
      content: 'Full article content would go here...',
      author: 'Jennifer Lee',
      date: '2024-01-08',
      readTime: '4 min read',
    ...
    },
    {
      ...
      excerpt: 'Proven strategies for creating meaningful connections with your clients that keep them coming back.',
      content: 'Full article content would go here...',
      author: 'Amanda Chen',
      date: '2024-01-05',
      readTime: '5 min read',
    ...
    },
    {
      ...
      excerpt: 'Effective strategies to showcase your work and attract new clients through social media platforms.',
      content: 'Full article content would go here...',
            ...
            <article className="max-w-4xl mx-auto">
              <header className="mb-8">
                <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-4">
                  <span className="px-3 py-1 bg-accent/10 text-accent rounded-full">{selectedPost.category}</span>
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Conclusion</h2>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">Beauty Industry Expert</p>
                    </div>
                  </div>
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 px-6 text-center bg-gradient-to-br from-white via-accent-50/30 to-accent-100/20 dark:from-gray-900 dark:via-accent-950/30 dark:to-accent-900/20">
          <div className="container mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white">Beauty Industry Blog</h2>
            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Expert insights, trends, and tips for beauty professionals. Stay ahead of the curve with our latest articles.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-6">
          <div className="container mx-auto">
            <h3 className="text-2xl font-bold mb-8 text-gray-900 dark:text-white">Featured Article</h3>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-4">
                  <span className="px-3 py-1 bg-accent/10 text-accent rounded-full">{featuredPost.category}</span>
                  <span className="flex items-center gap-1">
                    <CalendarIcon className="w-4 h-4" />
          ...
          <div className="container mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPosts.slice(1).map(post => (
                <article key={post.id} className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                  <img 
                    src={post.image} 
                    alt={post.title}
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-3">
                      <span className="px-2 py-1 bg-accent/10 text-accent rounded-full text-xs">{post.category}</span>
                      <span className="flex items-center gap-1">
        ...
        <section className="py-20 px-6 bg-accent text-white">
          <div className="container mx-auto text-center">
            ...
            <p className="max-w-xl mx-auto text-accent-100 mb-8">
              Subscribe to our newsletter and never miss the latest beauty industry insights and tips.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-accent">Features</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-accent">Pricing</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><button onClick={() => onNavigate('about')} className="text-gray-600 dark:text-gray-400 hover:text-accent">About</button></li>
                <li><button onClick={() => onNavigate('contact')} className="text-gray-600 dark:text-gray-400 hover:text-accent">Contact</button></li>
                <li><span className="text-accent font-semibold">Blog</span></li>
              </ul>
            </div>
            <div>
              <h5 className="font-semibold text-gray-900 dark:text-white mb-3">Legal</h5>
              <ul className="space-y-2 text-sm">
                <li><button onClick={() => onNavigate('privacy')} className="text-gray-600 dark:text-gray-400 hover:text-accent">Privacy Policy</button></li>
                <li><button onClick={() => onNavigate('terms')} className="text-gray-600 dark:text-gray-400 hover:text-accent">Terms of Service</button></li>
              </ul>
            </div>
          </div>
