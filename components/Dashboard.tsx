        ...
        {data.map((item, index) => (
          <div key={index} className="flex-1 flex flex-col items-center gap-2">
            <div className="text-xs font-bold text-gray-600 dark:text-gray-300">
              {item.value.toLocaleString(langCode, {
                style: 'currency',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <KPICard
            ...
            value={revenueData.todayRevenue.toLocaleString(langCode, {
              style: 'currency',
              currency: currencyCode,
            })}
          ...
          <KPICard
            ...
            value={revenueData.monthRevenue.toLocaleString(langCode, {
              style: 'currency',
              currency: currencyCode,
            })}
          ...
          <KPICard
            ...
            value={appointments.filter(app => app.date === getTodayString()).length.toString()}
