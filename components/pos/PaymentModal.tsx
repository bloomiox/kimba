...
export const PaymentModal: React.FC<PaymentModalProps> = ({ total, onConfirm, onCancel, onComplete }) => {
        ...
        return (
            <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-sm p-8 text-center animate-fade-in">
                    ...
                    <button onClick={onComplete} className="w-full px-6 py-3 bg-accent hover:opacity-90 rounded-lg font-semibold text-white">
    ...
    return (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-sm p-6 relative animate-fade-in">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400 mb-6">{t('pos.payment.pay', {amount: formattedTotal})}</p>
                ...
                <div className="mt-6 flex gap-3">
                    <button onClick={onCancel} className="w-full px-6 py-3 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-lg font-semibold text-gray-800 dark:text-gray-200">
                        {t('common.cancel')}
                    </button>
                    <button onClick={handleConfirm} className="w-full px-6 py-3 bg-accent hover:opacity-90 rounded-lg font-semibold text-white">
