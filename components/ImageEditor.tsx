...
const ImageEditor: React.FC<ImageEditorProps> = ({ imageToEdit, initialPrompt, onFinalize, onBack }) => {
    ...
    <div className="fixed inset-0 bg-gray-100/80 dark:bg-gray-900/80 backdrop-blur-xl z-50 flex flex-col items-center justify-center p-4 animate-fade-in">
      ...
      <div className="w-full max-w-6xl h-full flex flex-col lg:flex-row items-center gap-8 p-4">
        ...
        <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex flex-col bg-white/50 dark:bg-gray-800/50 p-6 rounded-lg overflow-y-auto">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Step 3: Refine Your Look</h2>
          
          {/* Image Adjustments */}
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
                 <h3 className="text-lg font-semibold text-accent">Image Adjustments</h3>
                 <button onClick={handleResetFilters} className="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Reset</button>
            </div>
            <div className="space-y-3">
              <div className="grid grid-cols-4 items-center gap-2">
                <label htmlFor="brightness" className="text-sm font-medium col-span-1">Brightness</label>
              ...
              <div className="grid grid-cols-4 items-center gap-2">
                <label htmlFor="contrast" className="text-sm font-medium col-span-1">Contrast</label>
              ...
              <div className="grid grid-cols-4 items-center gap-2">
                <label htmlFor="saturation" className="text-sm font-medium col-span-1">Saturation</label>
          ...
          <div className="mt-6 flex-grow flex flex-col">
            <h3 className="text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Custom Details</h3>
            <textarea
              value={prompt}
