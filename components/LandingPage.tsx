      ...
      <main className="flex-grow flex items-center justify-center">
        ...
        <section className="text-center py-20 px-6">
          <div className="container mx-auto">
            <h2 className="text-4xl md:text-6xl font-extrabold mb-4 tracking-tight">{t('landing.hero.title')}</h2>
            <p className="max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-400 mb-8">
              {t('landing.hero.subtitle')}
            </p>
            <div className="flex justify-center gap-4">
                <button onClick={() => onNavigate('signup')} className="px-8 py-4 bg-accent hover:opacity-90 rounded-lg text-lg font-bold text-white transition-all shadow-xl">{t('landing.hero.cta')}</button>
            </div>
