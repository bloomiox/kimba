      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {t('auth.landing.features.subtitle')}
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <FeatureCard
                icon={SparklesIcon}
                title={t('auth.landing.features.ai.title')}
                description={t('auth.landing.features.ai.description')}
              />
              <FeatureCard
                icon={UsersIcon}
                title={t('auth.landing.features.clients.title')}
                description={t('auth.landing.features.clients.description')}
              />
              <FeatureCard
                icon={CalendarIcon}
                title={t('auth.landing.features.appointments.title')}
                description={t('auth.landing.features.appointments.description')}
              />
              <FeatureCard
                icon={TrendingUpIcon}
                title={t('auth.landing.features.analytics.title')}
                description={t('auth.landing.features.analytics.description')}
              />
            </div>
          </div>
        </section>
        ...
        <section id="testimonials" className="py-20 px-6 bg-gray-100 dark:bg-gray-800/50">
          <div className="container mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {t('auth.landing.testimonials.subtitle')}
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <TestimonialCard
                quote={t('auth.landing.testimonials.t1.quote')}
                name={t('auth.landing.testimonials.t1.name')}
                salon={t('auth.landing.testimonials.t1.salon')}
              />
              <TestimonialCard
                quote={t('auth.landing.testimonials.t2.quote')}
                name={t('auth.landing.testimonials.t2.name')}
                salon={t('auth.landing.testimonials.t2.salon')}
              />
              <TestimonialCard
                quote={t('auth.landing.testimonials.t3.quote')}
                name={t('auth.landing.testimonials.t3.name')}
                salon={t('auth.landing.testimonials.t3.salon')}
              />
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="py-20 px-6">
          <div className="container mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {t('auth.landing.pricing.subtitle')}
              </p>
            </div>
            <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
              <PricingCard
                ...
                features={[
                  t('auth.landing.pricing.starter.f1'),
                  t('auth.landing.pricing.starter.f2'),
                  t('auth.landing.pricing.starter.f3'),
                ]}
              ...
              <PricingCard
                ...
                features={[
                  t('auth.landing.pricing.pro.f1'),
                  t('auth.landing.pricing.pro.f2'),
                  t('auth.landing.pricing.pro.f3'),
                  t('auth.landing.pricing.pro.f4'),
                ]}
              ...
              <PricingCard
                ...
                features={[
                  t('auth.landing.pricing.enterprise.f1'),
                  t('auth.landing.pricing.enterprise.f2'),
                  t('auth.landing.pricing.enterprise.f3'),
                ]}
        ...
        <section id="contact" className="py-20 px-6">
          <div className="container mx-auto text-center max-w-4xl">
            <h3 className="text-3xl md:text-4xl font-bold mb-3">
              {t('auth.landing.contact.title')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-12">
              {t('auth.landing.contact.subtitle')}
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="#pricing" className="text-gray-600 dark:text-gray-400 hover:text-accent">
                    Pricing
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="/privacy" className="text-gray-600 dark:text-gray-400 hover:text-accent">
                    {t('footer.legal.privacy')}
                  </a>
                </li>
                <li>
                  <a href="/terms" className="text-gray-600 dark:text-gray-400 hover:text-accent">
...
const TestimonialCard: React.FC<{ quote: string; name: string; salon: string }> = ({
  quote,
  name,
  salon,
}) => (
...
const PricingCard: React.FC<{
  ...
  onSelect: () => void;
  featured?: boolean;
}> = ({ plan, price, period, description, features, buttonText, onSelect, featured = false }) => (
  <div
    className={`p-8 border rounded-xl w-full max-w-sm ${featured ? 'border-accent ring-2 ring-accent shadow-2xl bg-white dark:bg-gray-800/50' : 'border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/20'}`}
  >
    <h4 className="text-lg font-semibold text-accent">{plan}</h4>
    <p className="text-4xl font-bold my-4 text-gray-900 dark:text-white">
      {price}{' '}
    ...
    <button
      onClick={onSelect}
      className={`w-full py-3 rounded-lg font-semibold transition-colors ${featured ? 'bg-accent text-white hover:opacity-90' : 'bg-accent/10 text-accent hover:bg-accent/20'}`}
    >
      {buttonText}
    </button>
  </div>
