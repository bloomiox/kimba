        ...
        {status === 'RESULT' ? (
             <div className="flex-grow flex items-center justify-center">
                <div className="flex flex-col sm:flex-row gap-4">
                    <button onClick={handleTryAgain} className="px-8 py-3 bg-gray-500 hover:bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 rounded-lg font-semibold text-white transition-colors">Try Another Style/Pose</button>
                    <button onClick={handleUseThisLook} className="px-8 py-3 bg-accent hover:opacity-90 rounded-lg font-semibold text-white transition-all">Use this Look</button>
                </div>
             </div>
        ): (
            <div className="flex-grow flex flex-col min-h-0">
                <p className="text-center text-gray-600 dark:text-gray-300 mb-3">Click a style to try it on your live image</p>
