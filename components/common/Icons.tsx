...
export const DesignStudioIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    width="24"
...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M20 13c-2 0-2 2-4 2-2 0-2-2-4-2-2 0-2 2-4 2-2 0-2-2-4-2" />
    <path d="M20 17c-2 0-2 2-4 2-2 0-2-2-4-2-2 0-2 2-4 2-2 0-2-2-4-2" />
    <path d="M4 11V9a4 4 0 0 1 4-4h0a4 4 0 0 1 4 4v2" />
    <path d="M16 11V9a4 4 0 0 0-4-4h0a4 4 0 0 0-4 4v2" />
    <path d="M12 11V9" />
  </svg>
);
...
export const PaletteIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    ...
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.424-.152-.845-.433-1.167-.281-.322-.682-.548-1.14-.632a5.003 5.003 0 0 1-4.116-4.116c-.084-.458-.31-.859-.632-1.14a1.662 1.662 0 0 1-1.167-.433C6.746 13.648 6 12.926 6 12c0-3.314 2.686-6 6-6 1.657 0 3.156.672 4.243 1.757L12 12" />
  </svg>
);
...
// FIX: Added missing BookOpenIcon for use in settings tabs.
...
// FIX: Added missing CreditCardIcon for POS and payment components.
...
// FIX: Added missing SparklesIcon for appearance settings.
...
// FIX: Added missing HeartIcon for the landing page footer.
...
// FIX: Added missing ListIcon for client page view toggles.
...
// FIX: Added missing GridIcon for client page view toggles.
...
// FIX: Added missing GripVerticalIcon for resizing appointments in the calendar.
...
export const TikTokIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M16 8.5c0-2.21-1.79-4-4-4v10.5c0-1.38-1.12-2.5-2.5-2.5S7 13.62 7 15s1.12 2.5 2.5 2.5 2.5-1.12 2.5-2.5V3"></path>
    <circle cx="16" cy="4.5" r="1.5"></circle>
  </svg>
);
...
export const ChatBubbleLeftIconSolid: React.FC<IconProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    width="24"
...
export const ShareIconSolid: React.FC<IconProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    width="24"
