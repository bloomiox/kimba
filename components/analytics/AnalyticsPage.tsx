...
import { DollarSignIcon, ClipboardListIcon, CloseIcon } from '../common/Icons';
...
const AnalyticsPage: React.FC = () => {
    const { t } = useSettings();
    const [activeTab, setActiveTab] = useState<'metrics' | 'sales'>('metrics');
  
    const tabClasses = (tabName: 'metrics' | 'sales') => 
