...
const BookingForm: React.FC = () => {
  const { salonName, services, hairstylists, appointments, addAppointment, findOrCreateClient } =
    useSettings();
      ...
      <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-8 text-center animate-fade-in">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Your appointment at {salonName} has been successfully booked.
          </p>
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-3">
                          ...
                          <div
                            className={`font-bold text-lg ${mapToAccentColor('text-accent-600')}`}
                          >
                            ${service.price}
                          </div>
                        </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Select who you'd like to provide your service
                </p>
              </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <span
                            className={`text-sm font-medium ${mapToAccentColor('text-accent-600')}`}
                          >
                            {hairstylist.type === 'expert'
                              ? 'Expert Stylist'
                              : hairstylist.type === 'station'
                                ? 'Station Stylist'
                                : 'Stylist'}
                          </span>
                        </div>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Tell us about yourself to complete the booking
                </p>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div
                  className={`p-6 ${mapToAccentColor('bg-accent-50 dark:bg-accent-900/20')} rounded-xl`}
                >
                  <h3
                    className={`text-lg font-semibold ${mapToAccentColor('text-accent-900 dark:text-accent-100')} mb-4`}
                  >
                    Appointment Summary
                  </h3>
